...
/*   Updated: 2021/01/16 12:26:34 by kaye             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    move_w(t_win *win)
{
    ...
    if (win->desc_info->map[(int)(win->camera->pos_y + win->camera->dir_y * win->camera->speed)]
...
void    move_a(t_win *win)
{
    ...
    if (win->desc_info->map[(int)(win->camera->pos_y - win->camera->plane_y * win->camera->speed)]
                     [(int)win->camera->pos_x] == '0')
